 ...
 * 최상위가 FW/MF 뿐이고 GK·DF(석신 GK · 석다이크 DF · 오시야스 GK)는 비활성이기 때문이다.
 * (구 주석은 여기 **권씨를 GK·DF 예시로 적었는데 권씨는 FW** 다 — #389 독립검증 F5 로 정정.
 *  권씨도 비활성인 것은 맞지만 그건 포지션 축 공백의 근거가 아니다.) 그래도 지급 덱은 정포지션
