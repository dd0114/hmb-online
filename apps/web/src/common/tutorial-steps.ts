...
export const TUTORIAL_STEPS: readonly TutorialStep[] = [
  ...
  {
    /**
     * ⚠️ **트레이드 코치마크는 여기 없다 — 못 붙인다**(#286 W3, hero Q5 "둘 다" 미이행).
     *
     ...
     *
     * 그래서 지금 트레이드 안내는 둘이다: ①이 스텝 **문구**가 트레이드를 명시 ②영입 탭의
     * **상시 안내 카드**(`trade-guide`). 진짜 코치마크를 원하면 **온보딩 동선을 영입 탭까지
     * 늘려야** 하고 그건 hero 결정이다(이슈 #286 에 올렸다).
     */
    id: "shop",
