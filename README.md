...
> ⚠️ **알려진 간헐 실패 — [#490](https://github.com/dd0114/hmb-online/issues/490).**
> 리그의 "다음 경기" 클릭이 간헐적으로 이동하지 않아 `league-season.spec.ts` 가 빨간불이 된다
> (콜드 6회 중 1회 재현).
> 게이트가 잡은 **앱 쪽** 결함이고 이 스크립트와 무관하다. 그 이슈가 닫히기 전까지 e2e red 는
> **먼저 이 스펙인지 확인**하라 — 아니면 진짜 회귀다.
