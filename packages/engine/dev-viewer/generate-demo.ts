 ...
 * → **27706468**(#377 M3-C · engine@0.36.0 — 스루패스 후보가 붙으며 27706463 에서 tackle 이
 * 0 이 됐다. **같은 부류가 세 번째**다: 쇼케이스 로그의 희귀 연출은 전개가 조금만 바뀌어도
 * 사라지고, 그래서 가드가 생성 시점에 있다. 재스캔(27706463+400, 네 축 동시 충족):
 * 골 6 · tackle 5 · 1대1 3 · 카드 5 · 선방 11 — 네 축 모두 여유가 있는 쪽으로 골랐다.
 * 후보들: 27706465(1v1 4·tk 3·card 2·골 6) · 27706467(3·5·3·10) · 27706472(2·5·5·8) ·
