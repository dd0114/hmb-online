...
const SEED = "1000000013"; // real config 에서 offside+card+penalty + #42(세이브→라이브체인→빗나감) 패턴을 모두 포함하는 시드. 매치 전개가 바뀔 때마다 **네 조건 전부**로 재스캔한다(1000000000 → 1000000004 → 1000000013, #178 픽스로 타임라인 변경). 스캔 결과 보유 시드: 1000000013/15/44/59/64.
