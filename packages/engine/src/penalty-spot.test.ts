...
//   → **"1"**(#370 슛 게이트 재설계 — 절대 xG 컷을 위치품질 하한으로 교체하며 전개가 바뀌어
//     시드 8 에서 페널티가 소멸). 재스캔 실측(1~60): penalty 보유 시드 **34개**
//     (1/2/4/6/11/12/15/16/18/21/22/23/25/28/29/30/32/35/37/38/40/41/43/44/45/46/48/49/50/52/54/55/56/58)
//     — #358 파울 모델 재정의로 넉넉해졌다. 최솟값 "1"(PK 3건)을 쓴다.
const PK_SEED = "1";
