...
//   → **18**(#377 M3-A · #369 예고 패스 — 리시버가 도착 예정 지점으로 먼저 움직이며 전개가
//     바뀌어 시드 28 에서 페널티가 소멸).
//     ⚠️ **희소하다** — 1~80 에 보유 시드가 **18 하나뿐**이라 범위를 1~200 으로 넓혀 뽑았다:
//     **18**(PK 1·6골) · 104(1·6) · 158(1·5) · 160(1·6) · 195(1·4). 다음 재스캔자는 처음부터
//     1~200 으로 잡아라. 상류(파울)가 벤치 아래라 PK 적중률이 낮은 것이 근본이다.
const PK_SEED = "18";
