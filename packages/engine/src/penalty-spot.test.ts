...
// #407 ⑦(0.42.0): 오프사이드 콜 빈도 재보정(`rules.offside.callProb` 0.013→0.045)으로 전개가
//   바뀌며 **15 에서 PK 가 사라졌다**. 1~300 재스캔(스캐너 = `research/e407-probe/e407-pk-seed-scan.ts`)
//   PK 보유 시드 7개 — **129(PK1·골10)** · 102(1·8) · 23(1·7) · 43(1·7) · 210(1·6) · 24(1·4) ·
//   285(1·2). 129 가 골 10 으로 표본이 가장 넉넉하다.
//   ⚠️ 이 스캔은 `callProb` 값에 민감하다 — 출하값 0.045 가 아니라 사다리 rung 0.055 로 재면
//   보유 시드가 10개(1·129·83·102·180·23·284·7·136·24)로 달라진다(위 7개 목록이 출하값 기준).
//   노브를 다시 만지면 스캐너를 다시 돌린다.
const PK_SEED = "129";
