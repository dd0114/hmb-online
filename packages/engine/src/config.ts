...
export const defaultEngineConfig: EngineConfig = {
  ...
  //   0.013 → **0.055** — 판정 로직은 무변경(FP 0 확정)이고 빈도 게이트 하나만 재보정했다.
  //   n60: 오프사이드 0.425 → **1.392**(벤치 1–3 진입). 부작용은 전부 밴드 쪽 또는 중립 —
  //   슛 17.48 → 16.82 · 파울 4.83 → 5.08 · 코너 5.89 → 5.46 · 패스% 82.8 → 82.6.
