...
**소진**: 2026-08-02 발차. 라이브 engine@0.40.0 · **Flyway v37**. V37 리허설·구 java 기동 확인·#396
프리플라이트 근거는 `deploy-log` v3.15 항목에 남겼다. 이어서 **`v3.16` web 단독**으로 권씨 아트(#389)
+ 웹픽스 2건(#386·#388)까지 나갔다 — 라이브 web = **`80e25a8`**.)
